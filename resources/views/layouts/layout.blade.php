...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ URL::asset('css/images/ico/apple-touch-icon-144-precomposed.png') }}">
                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> +07 33 33 33 21</a></li>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="/"><img src="{{ URL::asset('css/images/home/logo.png') }}" alt="" /></a>
                    </div>
                </div>
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            @if(\Illuminate\Support\Facades\Session::has('name'))
                                <li><a href="/logout"><i class="fa fa-briefcase"></i> Logout</a></li>
                                <li><a>{{(\Illuminate\Support\Facades\Session::get('name'))}}</a></li>
                            @else
